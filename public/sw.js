...
const CACHE_NAME = 'retos-futbol-' + new Date().getTime();
...
const PRECACHE_URLS = [
  ...
  '/src/App.css',
  '/src/pwa-styles.css',
  // Add other core assets to cache
];

// Cache name for the current version of the app
const CURRENT_CACHES = {
  prefetch: 'prefetch-cache-v' + new Date().getTime()
};
